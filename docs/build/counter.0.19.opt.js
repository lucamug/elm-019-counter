...
var _Browser_embed = _Debugger_embed || F4(function(impl, flagDecoder, debugMetadata, object)
{
	object['embed'] = function(node, flags)
	{
		return _Platform_initialize(
			...
			impl.av,
			impl.H,
			_Browser_makeStepperBuilder(node, impl.aw)
		);
	};
	return object;
});
	...
	object['fullscreen'] = function(flags)
	{
		return _Platform_initialize(
			...
			_Browser_makeStepperBuilder(_VirtualDom_doc.body, function(model) {
				var ui = impl.aw(model);
				if (_VirtualDom_doc.title !== ui.au)
				{
					_VirtualDom_doc.title = ui.au;
				}
				return _VirtualDom_node('body')(_List_Nil)(ui.ai);
			})
		);
	};
	return object;
...
var _Browser_decodeEvent = F2(function(decoder, event)
{
	...
	return elm$core$Result$isOk(result)
		...
		: elm$core$Maybe$Nothing
});var author$project$Main$initialModel = {n: 0};
...
var elm$browser$Browser$sandbox = function (_n0) {
	var init = _n0.ao;
	var view = _n0.aw;
	var update = _n0.av;
	return elm$browser$Browser$embed(
		{
			ao: function (_n1) {
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{ao: author$project$Main$initialModel, av: author$project$Main$update, aw: author$project$Main$view});
